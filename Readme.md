...
| Action: reply input field                                                                                                                    | ✅     | ❌                                                        | [#2](https://github.com/Simon-Laux/user-notify/issues/2) | [`NotificationCategoryAction::TextInputAction`](https://docs.rs/user-notify/latest/user_notify/enum.NotificationCategoryAction.html#variant.TextInputAction)                                           |
